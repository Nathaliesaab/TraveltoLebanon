                ...
                <div className="col-5 image about-text">
                    <div className="about">
                        ...
                        <div className="about">
                            ...
                            The capital is Beirut.It has 7 districts as you can see on the map.
                ...
                <div className="col-12 desc">
                    <div className="col-12 text-center">
                        <div className="title-about">
                            About Lebanon's Four Seasons
                        </div>
                    </div>


                    <div className="description">
                        Lebanon has a typically Mediterranean climate, characterized by a long, hot, and dry summer.
                        Winter can be rather cool and rainyThere are four seasons in Lebanon. Summer (June to September) is hot on the coast and cooler in the mountains.
